...
const featureList = [
  ...
  },
  {
    ...
    description: '24/7 Access to an AI Powered Home Ownership Advisor that integrates with your home\'s historical records.',
  }
];
...
export function Features({ onTryNow }: { onTryNow?: () => void }) {
  return (
    <div className="w-full pt-12 pb-8 bg-slate-50/50">
